package com.syc.salesAgent.service;

import com.syc.salesAgent.dto.*;
import com.syc.salesAgent.entity.SalesOrder;
import com.syc.salesAgent.entity.SalesRep;
import com.syc.salesAgent.repository.*;
...
public class SalesQueryService {
    ...
    public List<ProductSalesDTO> queryProductRanking(LocalDate start, LocalDate end, int topN) {
        ...
        Map<Long, com.syc.salesAgent.entity.Product> productMap = productRepository.findAll().stream()
        ...
        for (Object[] row : raw) {
            ...
            com.syc.salesAgent.entity.Product p = productMap.get(productId);
            if (p == null) continue;
